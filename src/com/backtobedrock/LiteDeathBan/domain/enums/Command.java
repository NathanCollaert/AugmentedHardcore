...
public enum Command {
    LITEDEATHBAN(null, null, null, null, null),
    HELP(Permission.HELP, LITEDEATHBAN, Collections.emptyList(), Collections.emptyList(), "List of LiteDeathBan commands"),
    ADDLIVES(Permission.ADDLIVES, LITEDEATHBAN, Arrays.asList("player", "amount"), Collections.emptyList(), "Add lives to a player"),
    ADDLIFEPARTS(Permission.ADDLIFEPARTS, LITEDEATHBAN, Arrays.asList("player", "amount"), Collections.emptyList(), "Add life parts to a player"),
    SETLIVES(Permission.SETLIVES, LITEDEATHBAN, Arrays.asList("player", "amount"), Collections.emptyList(), "Set the lives of a player"),
    SETLIFEPARTS(Permission.SETLIFEPARTS, LITEDEATHBAN, Arrays.asList("player", "amount"), Collections.emptyList(), "Set the life parts of a player"),
    RELOAD(Permission.RELOAD, LITEDEATHBAN, Collections.emptyList(), Collections.emptyList(), "Reload LiteDeathBan"),
